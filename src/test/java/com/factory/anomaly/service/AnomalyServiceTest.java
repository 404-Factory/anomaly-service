...
class AnomalyServiceTest {
    ...
    @BeforeEach
    void setUp() {
        anomalyService = new AnomalyServiceImpl(
                anomalyRepository,
        ...
        ReflectionTestUtils.setField(anomalyService, "self", anomalyService);
        ReflectionTestUtils.setField(anomalyService, "eventPublishEnabled", false);
    }
    ...
    void testDetectNewViolation() {
        ...
        // When
        Optional<Anomaly> result = anomalyService.detect(violation);
    ...
    void testDetectPublishesOutboxEvent() {
        // Given
        ReflectionTestUtils.setField(anomalyService, "eventPublishEnabled", true);
        ...
        assertThat(payload.getAnomalyId()).isEqualTo(10L);
